...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String urlProfileImg = "https://plus.google.com/photos/102124053149356203268/albums/profile/6545333716390647266?iso=false";
    ...
    private static final String TAG_NEA = "nea";
    private static final String TAG_LOKSEWA = "loksewa";
...
//    }
    ...
    private void loadNavHeader() {
        ...
        txtWebsite.setText("www.ccss.nast.qrce.com");
...
//              //  android.app.FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
...
//                fragmentTransaction.commitAllowingStateLoss();
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 1:
//                // photos
                NTCFragment ntcFragment = new NTCFragment();
                return ntcFragment;
            case 2:
//                //  movies fragment
